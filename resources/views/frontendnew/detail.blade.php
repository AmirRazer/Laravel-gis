            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>{{ $spot->kecamatan->name }}</p> <!-- Pastikan model Kecamatan memiliki field 'name' -->
                        </p>

                        <p>
                        <h4><strong>Kategori :</strong></h4>
                        <p>{{ $spot->kategori->name }}</p> <!-- Pastikan model Kategori memiliki field 'name' -->
                        </p>
                         <p>
                        ...
                        <img class="img-fluid" width="400" src="{{ $spot->getImageAsset() }}" alt="">
                        </p>
                    </div>
                </div>
            </div>
