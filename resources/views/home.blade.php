...
@section('content')
    ...
    <script>
        // Fungsi untuk memperbarui dropdown detail kategori berdasarkan kategori yang dipilih
        $('#kategori').change(function() {
            ...
            $.ajax({
                url: '/getChartData/' + kategoriId + '/0', // Sesuaikan URL
                type: 'GET',
                dataType: 'json',
                success: function(data) {
        ...
        // Fungsi untuk memperbarui grafik berdasarkan kategori dan detail kategori yang dipilih
        function updateChart() {
            var kategoriId = $('#kategori').val();
            console.log(kategoriId);
            var detailKategoriId = $('#detailkategori').val();
            $.ajax({
                url: '/getChartData/' + kategoriId + '/' + detailKategoriId, // Sesuaikan URL
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    myChart.data.labels = data.labels;
        ...
        // Event listener untuk dropdown detail kategori
