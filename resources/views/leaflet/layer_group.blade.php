...
@push('javascript')
    ...
    <script>
        ...
        var office = L.layerGroup().addTo(map);
        var places = L.layerGroup().addTo(map);

        var map = L.map('map', {
            center: [-6.658693935480687, 110.90424904157845],
            zoom: 13,
            layers: [places, office]
        })

        var marker1 = L.marker([-6.680686411017694, 110.90297152692682], {
                icon: iconMarker,
                draggable: true,
        ...
        var marker3 = L.marker([-6.681127666135418, 110.89521447581038], {
                // icon: iconMarker,
                draggable: false,
                title: "Klik untuk menambahkan marker",
            })
