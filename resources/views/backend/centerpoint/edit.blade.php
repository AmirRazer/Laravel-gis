                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$centerpoint->coordinate}}" class="form-control @error('coordinate')
                                    is-invalid
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$centerpoint->coordinate}}" class="form-control" name="latitude" id="latitude">
                        </div>
                        <div class="form-group">
                            <label for="">Longitude</label>
                            <input type="text" value="{{$centerpoint->coordinate}}" class="form-control" name="longitude" id="longitude">
                        </div>
